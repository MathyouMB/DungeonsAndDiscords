...
declare module "discord.js" {
    ...
    export class GuildChannel extends Channel {
        ...
        public permissionOverwrites: Collection<
            Snowflake,
    ...
    export class MessageFlags extends BitField<MessageFlagsString> {
        ...
        public static resolve(
            bit?: BitFieldResolvable<MessageFlagsString>
        ): number;
    }
    ...
    export class Permissions extends BitField<PermissionString> {
        ...
        public serialize(
            checkAdmin?: boolean
        ): Record<PermissionString, boolean>;
    ...
    export class Structures {
        public static get<K extends keyof Extendable>(
            structure: K
        ): Extendable[K];
        public static get(structure: string): (...args: any[]) => void;
        public static extend<
            K extends keyof Extendable,
            T extends Extendable[K]
        >(structure: K, extender: (baseClass: Extendable[K]) => T): T;
    ...
    export class Util {
        ...
        public static discordSort<
            K,
            V extends { rawPosition: number; id: string }
